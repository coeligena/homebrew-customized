cask 'java7-jce-strong-policy' do
  ...
  uninstall_postflight do
    system '/usr/bin/sudo', '-E', '--',
      '/bin/mv', "/Library/Java/JavaVirtualMachines/#{Utils.java_dir}/Contents/Home/jre/lib/security/local_policy.jar.backed_up", "/Library/Java/JavaVirtualMachines/#{Utils.java_dir}/Contents/Home/jre/lib/security/local_policy.jar"
    system '/usr/bin/sudo', '-E', '--',
      '/bin/mv', "/Library/Java/JavaVirtualMachines/#{Utils.java_dir}/Contents/Home/jre/lib/security/US_export_policy.jar.backed_up", "/Library/Java/JavaVirtualMachines/#{Utils.java_dir}/Contents/Home/jre/lib/security/US_export_policy.jar"
  end
end